...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.bgls.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.bgls.security.DomainUserDetailsService", "createSpringSecurityUser");
